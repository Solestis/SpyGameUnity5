...
public enum PhotonNetworkingMessage
{
    ...
    /// <summary>
    /// Called when this client created a room and entered it. UpdatePlayerList() will be called as well.
    /// </summary>
    /// <remarks>
    ...
    /// 
    /// Note that OnPhotonSerializeView is not called on remote clients when the senderPlayer does not send
