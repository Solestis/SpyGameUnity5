...
public static class PhotonNetwork
{
    ...
    /// <param name="content">The content the senderPlayer put into the event.</param>
    ...
    /// </summary>
    /// <remarks>
    /// When successful, this calls the callbacks OnCreatedRoom and UpdatePlayerList (the latter, cause you join as first player).
    ...
    ///
    /// UpdatePlayerList() gets called if the room existed and was joined,
    ...
    /// <see cref="PhotonNetworkingMessage.UpdatePlayerList"/>
    ///
    ...
    /// <summary>Join room by roomname and on success calls UpdatePlayerList(). This is not affected by lobbies.</summary>
    /// <remarks>
    /// On success, the method UpdatePlayerList() is called on any script. You can implement it to react to joining a room.
    ///
    ...
    /// You know if this client created a room, if you get a callback OnCreatedRoom (before UpdatePlayerList gets called as well).
    /// </remarks>
    ...
    /// JoinRandomRoom call are ignored. The event/callback UpdatePlayerList gets called (see enum PhotonNetworkingMessage).
    /// </remarks>
    /// <param name="expectedCustomRoomProperties">Filters for rooms that match these custom properties (string keys and values). To ignore, pass null.</param>
    /// <param name="expectedMaxPlayers">Filters for a particular maxplayer setting. Use 0 to accept any maxPlayer value.</param>
    ...
    /// the same GameObjects and PhotonViews). You can call this in UpdatePlayerList.
    ///
