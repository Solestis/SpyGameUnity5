...
public class ConnectAndJoinRandom : Photon.MonoBehaviour
{
    ...
    {
        Debug.Log("UpdatePlayerList() called by PUN. Now this client is in a room. From here on, your game would be running. For reference, all callbacks are listed in enum: PhotonNetworkingMessage");
    }
